  ...
  <div class="main">
    ...
    <ul class="userinfo-list">
      ...
      <li>
        ...
        <input type="text" name="" class="userinfo-list-lr fl" placeholder="请输入支付宝账号" v-model="myZfb"
               @blur="testZfb(myZfb)">
      </li>
      <li>
        <span class="userinfo-list-lf fl">
        ...
        <input type="text" name="" class="userinfo-list-lr fl" placeholder="请输入支付宝真实姓名" v-model="myZfbName"
    ...
    <mt-popup v-model="mypopup1" position="bottom" class="cityPopup">
      <div class="userpopup">
        ...
        <mt-picker :slots="slots" value-key="aname" class="myCityPopup"></mt-picker>
